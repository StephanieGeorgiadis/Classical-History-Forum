...
class AppContainer extends Component {
  ...
  render() {
    ...
    if (forums) {
      return (
        <div>
          <Helmet><title>Classical History Forum</title></Helmet>

          <div className={styles.gitForkTag}>
            <a className={styles.gitLink} href="https://github.com/StephanieGeorgiadis/Classics-Forum" target="_blank">Fork on Github</a>
          </div>
